...
def main():
    # Read data
    Nifty50 = StockDataLoader.load_csv(r"C:\\Users\\AANCHAN\\OneDrive - Capgemini\\Hackathon\\Dataset\\NIFTY 50_with_indicators_.csv")
    NiftyBank = StockDataLoader.load_csv(r"C:\\Users\\AANCHAN\\OneDrive - Capgemini\\Hackathon\\Dataset\\NIFTY BANK_with_indicators_.csv")
